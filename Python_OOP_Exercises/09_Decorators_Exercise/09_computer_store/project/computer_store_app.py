...
class ComputerStoreApp:
    ...
    VALID_TYPES_OF_COMPUTERS = {"Desktop Computer": DesktopComputer, "Laptop": Laptop}
    ...
    def build_computer(self, type_computer: str, manufacturer: str, model: str, processor: str, ram: int):
        if type_computer not in self.VALID_TYPES_OF_COMPUTERS:
            raise ValueError(f"{type_computer} is not a valid type computer!")

        computer = self.VALID_TYPES_OF_COMPUTERS[type_computer](manufacturer, model)
